...
/*
*
* This is how you "should" do it (through extension points), but the TestFinderHelper typing doesn't allow it
*
* */

public class ActionScriptTestFinder implements TestFinder{
